  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 ${
        mode === 'dark' ? 'bg-gray-900 text-white' : 'bg-orange-300 text-gray-900'
      } shadow-lg py-4 px-6 flex items-center justify-between md:justify-between`}
    >
      <Link
        to="/"
      ...
      <nav
        className={`flex-1 hidden md:flex md:justify-center items-center space-x-6 ${
      ...
      <nav
        className={`fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-90 ${
          isOpen ? 'block' : 'hidden'
        } md:hidden md:bg-transparent md:static md:h-auto md:flex md:items-center md:space-x-6`}
      >
